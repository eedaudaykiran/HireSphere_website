...
class JobAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('📋 Basic Info', {
            # FIX: replaced 'experience' with 'min_experience', 'max_experience'
            # because experience CharField was removed from Job model
            'fields': ('title', 'company', 'location', 'min_experience', 'max_experience', 'work_mode', 'job_type', 'status', 'is_active')
        }),
        ('💰 Salary', {
